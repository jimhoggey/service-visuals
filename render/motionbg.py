...
from .encoder import (HEIGHT, OUTPUT_FPS, WIDTH, encode_parallel,
                      export_path)
...
def _render_aurora(total_frames, scheme, progress_cb, out_path):
    ...
    def make_frame(k):
        ...
        return frame.resize((WIDTH, HEIGHT), _LANCZOS)

    encode_parallel(out_path, OUTPUT_FPS, total_frames, make_frame, progress_cb)
...
def _render_waves(total_frames, scheme, progress_cb, out_path):
    ...
    def make_frame(k):
        ...
        return frame.convert("RGB").resize((WIDTH, HEIGHT), _LANCZOS)
